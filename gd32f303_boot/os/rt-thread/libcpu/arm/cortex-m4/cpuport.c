...
void rt_hw_hard_fault_exception(struct exception_info *exception_info)
{
    ...
    uint32_t hfsr = SCB->HFSR;      // Hard Fault ×´Ì¬¼Ä´æÆ÷ (0xE000ED2C)
    uint32_t cfsr = SCB->CFSR;      // ¿ÉÅäÖÃ¹ÊÕÏ×´Ì¬¼Ä´æÆ÷ (0xE000ED28)
    uint32_t mmfar = SCB->MMFAR;    // MemManage ¹ÊÕÏµØÖ·¼Ä´æÆ÷ (0xE000ED34)
    uint32_t bfar = SCB->BFAR;      // ×ÜÏß¹ÊÕÏµØÖ·¼Ä´æÆ÷ (0xE000ED38)
