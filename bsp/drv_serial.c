 ...
 * 2025-02-20     Cline        Fixed for GD32F303 and RT-Thread compatibility
 */
...
//        GPIOA, GPIO_AF_7, GPIO_PIN_3,           // rx port, rx alternate, rx pin
        RCU_GPIOD, RCU_GPIOA,                   // tx gpio clock, rx gpio clock
...
//        GPIOB, GPIO_AF_7, GPIO_PIN_11,          // rx port, rx alternate, rx pin
        RCU_GPIOD, RCU_GPIOD,                   // tx gpio clock, rt gpio clock
    ...
    #ifdef BSP_USING_UART3
    {
      ...
      //GPIOC, GPIO_AF_8, GPIO_PIN_11,         // rx port, rx alternate, rx pin
			  ...
			  RCU_GPIOA, RCU_GPIOC,                  // tx gpio clock, rt gpio clock
...
/**
  * @brief  uart dma transmit
  * @param  serial, buf, size, direction
  * @retval transmitted size
  */
static rt_ssize_t gd32_uart_dma_transmit(struct rt_serial_device *serial, rt_uint8_t *buf, rt_size_t size, int direction)
{
    /* TODO: Implement DMA transmit for GD32 */
...
static const struct rt_uart_ops gd32_uart_ops =
{
    ...
    .putc = gd32_uart_putc,
    .getc = gd32_uart_getc,
    .dma_transmit = gd32_uart_dma_transmit,
};
