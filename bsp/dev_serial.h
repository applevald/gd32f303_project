...
/* Define rt_ssize_t if not already defined */
#ifndef rt_ssize_t
typedef rt_int32_t rt_ssize_t;
#endif
...
/* RT_OBJECT_HOOKLIST_DECLARE is not defined in this RT-Thread version, use simplified hook */
#ifdef RT_USING_HOOK
extern rt_hw_serial_rxind_hookproto_t rt_hw_serial_rxind_hook;
#define rt_hw_serial_rxind rt_hw_serial_rxind_hook
#else
#define rt_hw_serial_rxind RT_NULL
#endif
