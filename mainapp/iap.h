...
#define APP_ADDR               0x0800C800          /* APP起始地址 */
#define APP_SIZE               (103 * 1024)        /* 约103KB */
#define APP_END_ADDR           0x0801FFFF          /* APP结束地址 */

#define BACKUP_ADDR            0x08020000          /* 备用区域起始地址 */
#define BACKUP_SIZE            (128 * 1024)        /* 128KB */
